...
public class BillController {
    ...
    public BillResponse generate(@PathVariable UUID meterReadingId) {
    ...
    public BillResponse approve(@PathVariable UUID id) {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN','FINANCE')")
    @Operation(summary = "Get bill by ID", description = "Returns complete bill details by UUID.")
    ...
    public List<BillSummaryResponse> findByCustomer(@PathVariable UUID customerId) {
